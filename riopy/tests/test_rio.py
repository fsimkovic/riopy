...
class TestRio(unittest.TestCase):
    def test_calculate_dists_2d_1(self):
        ...
        self.assertListEqual([0.000], dists)

    def test_calculate_dists_2d_2(self):
        a = np.array([[1.000, 1.000, 1.000]])
        b = np.array([[-1.000, -1.000, -1.000]])
        dists = Rio.calculate_dists_2d(a, b)
        self.assertListEqual([3.464], dists)
    ...
    def test_calculate_dists_2d_4(self):
        ...
        dists = Rio.calculate_dists_2d(a, b)
        self.assertListEqual([3.464, 5.196], dists)
    ...
    def test_calculate_dists_2d_5(self):
        ...
        dists = Rio.calculate_dists_2d(a, b)
        self.assertListEqual([1.407, 0.430, 1.434], dists)

    def test_find_contacts_1(self):
        self.assertListEqual([], Rio.find_contacts(np.array([]), 0.0))

    def test_find_contacts_2(self):
        self.assertListEqual([], Rio.find_contacts(np.array([1.000]), 0.0))

    def test_find_contacts_3(self):
        self.assertListEqual([1], Rio.find_contacts(np.array([1.000, 0.500, 0.510]), 0.5))

    def test_find_contacts_4(self):
        self.assertListEqual([0, 1], Rio.find_contacts(np.array([-1.000, 0.500, 0.510]), 0.5))
